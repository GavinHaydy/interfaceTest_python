...
class Run:
    def __init__(self, cases_directory, file_name, file_name_1, language):
        Script(cases_directory, file_name, file_name_1)
        sleep(3)
    ...
    """
    # BeforeRun('http://106.13.171.218', '/v2/api-docs', '/home/bugpz/文档/api_t1.csv', '/home/bugpz/文档/test_1', './Test')
